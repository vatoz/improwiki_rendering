...
\subsection{Průběh}  
Připraví se \textif{n}{} židlí, na které se neutrálně usadí stejný počet herců. Hráč, který sedí nedělá nic. Poté, co kategorie začne se mění příběh podle kombinace herců, kteří zrovna stojí. Herci si stoupají a sedají podobně jako v kategorii \odkaz{Toaster}{toaster}, nikoliv ale však na signál, ale pocitově. Pokud hráč stojí, tak vypráví příběh, který náleží kombinaci herců, kteří stojí s ním - každá kombinace herců tak má vlastní příběh, proto ''2\^{}n-1'' příběhů. Kategorie skončí v momentě, kdy jsou všechny příběhy dovyprávěny. 
