...
\needspace{5cm} \section{Hudební nálady} \label{hudební nálady} Mnoho hudebníků hraje pořád stejně. Zde jsou některé nálady jako inspirace pro další variace: 
\begin{itemize}
\item něžně
\item "natvrdle"{} ([https://www.youtube.com/watch?v=BPFKMco8AL0&list=PLKPYI9ACDonB7jrbv_eAPdJpQVgbjWoDZ&index=2 Chicago - All That Jazz])
\item pohodově
\item vesele
\item smutně
\item těžkopádně (\textbf{Prokofiev - Dance of the Knights})
\item tajemně ([https://www.youtube.com/watch?v=EBGvtkVVas0&index=1&list=PLKPYI9ACDonB7jrbv_eAPdJpQVgbjWoDZ Marilin Manson - Resident Evil])
\item akčně
\end{itemize}
...
\item 2017 - Improtřesk 2017 - Na vlastní kůži - KD Milevsko
\item 2018 - Improtřesk 2018 - Otevřeno nonstop - KD Milevsko
\end{itemize}
 
Improtřesk 2012 organizovalo SVČ Lužánky,  
Improtřesk 2013 a 2014 skupina Bafni, Improtřesk 2015 -2018  \odkaz{ČILI}{čili} a přátelé. 
...
\begin{itemize}
\item  Praha - \textbf{Škola improvizace} -  Ondřej Nečas, \odkaz{Vanda Gabrielová}{uživatel:vandagabi} , Pája Sedláčková, Táňa Jírová a další ; \textbf{Impro Institut}  - Martin Vasquez ; \textbf{Nandaru} - Pavel Wieser, Kateřina Nováková
...
\needspace{5cm} \section{Web Improliga.cz} \label{web improliga.cz} Web improliga.cz je realizován na publikačním systému Wordpress s na míru psaným rozšířením které 
\begin{itemize}
\item  Obsahuje správu skupin-členů (Včetně polí město, geokoordináty, web, facebook)
\item  Obsahuje správu skupin-nečlenů (pouze facebook)
\end{itemize}
Tyto dva seznamy jsou automaticky/naplánovanou úlohou (každý by měl přijít na řadu alespoň jednou denně) procházeny na seznam nových událostí skupiny a událostí skupinou sdílených. 
Nalezené události se v okamžiku prvního nasosnutí zkopírují do nové události,  na základě hledání v názvu a v popisu se jim přiřadí zařazení mezi workshopy / představení. 
Jednou za čas admin (nyní \odkaz{Uživatel:Vatoz}{uživatel:vatoz}) poopraví zařazení, případně promazává nesmysly, a doplňuje u zápasů druhý tým. 
Rozšíření dále umí vykreslit mapu (kde je u týmů psáno buď místo tréninků nebo domovská scéna) 
Nedílnou součástí je i generování polotovaru na pravidelné týdenní výpisy na facebook, které se pak dopisují, zpřesňují (primárně rozdělení zápas, improshow, longformy, site-specific, sólová improvizace, EN , vystoupení účastníků kurzu ) a publikují. 
 
Další součástí webu je child téma pro šablonu (čili obsahuje minimum kódu) které realizuje vykreslování týmu, seznamu týmů a seznamu představení. 
 
Kód je na https://github.com/vatoz/wpimprov a případně https://github.com/vatoz/wpimprov_vantage_child 
...
Ve výkonném výboru  Čili jsou v tuto chvíli  Táňa Jírová, Martin Dočkal a \odkaz{Václav Černý}{uživatel:vatoz}. 
V revizní komisi jsou v tuto chvíli  Pavel Wieser, Jan Formánek a \odkaz{Vanda Gabrielová}{uživatel:vandagabi}. 
